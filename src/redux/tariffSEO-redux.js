...
let inititalState = {
    ...
    mobileCreate : {
        title: 'Стоимость разработки мобильных приложений',
        cases : [
            {
                color: cl.red,
                title: 'Типовой',
    ...
    CRMSystem : {
        title: 'Стоимость разработки CRM-систем ',
        cases : [
            {
                color: cl.red,
                title: 'Типовой',
                list: [
                    'Типовой дизайн',
                    'Только типовые БП',
                    'Только типовые отчеты',
                    'Возможны незначительные доработки',
                ],
                ...
                list: [
                    ...
                    'Интеграции нового функционала выбранной CRM по желанию',
                    'Бизнес-процессы',
                    'Отчеты',
                ],
                ...
                list: [
                    ...
                    'Любые интеграции в необходимом объеме',
                    'Любой функционал по желанию',
                    'Любая аналитика',
                ],
