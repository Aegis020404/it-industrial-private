...
const MainKeys = ()=>{
    ...
    const itemInfo = [{count: 2, info: [{descr: 'Интернет-магазин «Строймат»', classes: cl.imgPhone, img: imgPhone, alt: 'Website компании "Строймат" на телефоне'}, {descr: 'Интернет-магазин «Автоэстетика»', classes: cl.imgAmout, img: imgAmout, alt: 'Website компании "Автоэстетика" на телефоне и ноутбуке'}]}, {count: 1, info: [{descr: 'Сайт компании «Llumar»', classes: [cl.imgPad, cl.imgPadM], img: [imgPag, imgPadM], alt: 'Website компании "Llumar" на планшете'}]}, {count: 2, info: [{descr: 'Разработка сайта компании «Эковтор»', classes: cl.imgEva, img: [imgEvo, imgFamale, imgEkoM], alt: '"Ековтор" - экологически чистая компания, спасает природу, перерабатывая бумагу, пластик, пластмассы'}, {descr: 'Сайт для хоккейной команды', classes: cl.imgMiniPad, img: imgPadH, alt: 'Website хоккейной команды на планшете'}]}]
