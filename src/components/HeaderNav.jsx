...
const HeaderNav = ({active, headerNav, mainBlock, setHeaderNav, burgerA})=>{
    ...
    {title: 'Разработка и развитие', page: '/mobile-develop',titleClass: cl.headerCItitleD , info: [{link: 'Создание сайтов', class: cl.headerCIItemB},{link: 'Техническая поддержка сайтов', class: cl.headerCIItemB},{link: 'Создание мобильного приложения', class: cl.headerCIItemB},{link: 'Модернизация и поддержка приложений', class: cl.headerCIItemB},{link: 'Продвижение мобильных приложений', class: cl.headerCIItemB}]},
            ...
            <div className={cl.headerDropContent}>
                <ul className={cl.headerDropMainList}>
                    <li className={cl.headerDropItem}>
                        <div className={cl.headerDropIPromotion}>
                            <ul className={cl.headerDropIList}>
                                <HeaderItem burgerA={burgerA} setHeaderNav={setHeaderNav} titleClass={infoItem[0].titleClass} page={infoItem[0].page} title={infoItem[0].title} info={infoItem[0].info}/>
                            </ul>
                            <ul className={cl.headerDropIList}>
                                <HeaderItem burgerA={burgerA} setHeaderNav={setHeaderNav} titleClass={infoItem[1].titleClass} page={infoItem[1].page} title={infoItem[1].title} info={infoItem[1].info}/>
                            </ul>
                        </div>
                    </li>
                    <li className={cl.headerDropItem}>
                        ...
                        <ul className={cl.headerIList}>
                                    <HeaderItem  burgerA={burgerA} setHeaderNav={setHeaderNav} titleClass={infoItem[2].titleClass} page={infoItem[2].page} title={infoItem[2].title} info={infoItem[2].info}/>
                                </ul>
                                <ul className={cl.headerIList}>
                                    <HeaderItem   burgerA={burgerA} setHeaderNav={setHeaderNav} titleClass={infoItem[3].titleClass} page={infoItem[3].page} title={infoItem[3].title} info={infoItem[3].info}/>
                                </ul>
                        </div>
                    </li>
                    <li className={cl.headerDropItem}>
                        <div className={cl.headerDropIDev}>
                            <ul className={cl.headerDropIList}>
                                <HeaderItem  burgerA={burgerA} setHeaderNav={setHeaderNav} titleClass={infoItem[4].titleClass} page={infoItem[4].page} title={infoItem[4].title} info={infoItem[4].info}/>
                            </ul>
                        </div>
                    </li>
                    <li className={[cl.headerDropItem, cl.mHeaderDropItem].join` `}>
                        <div className={cl.headerDropIDev}>
                            <ul className={cl.headerDropIList}>
                                <HeaderItem  burgerA={burgerA} setHeaderNav={setHeaderNav} titleClass={infoItem[5].titleClass} page={infoItem[5].page} title={infoItem[5].title} info={infoItem[5].info}/>
                            </ul>
                        </div>
                    </li>
                </ul>
