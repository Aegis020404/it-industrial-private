...
const HeaderNav = ({active, headerNav, mainBlock, setHeaderNav, burgerA})=>{
    ...
    {title: 'Меню', titleClass: cl.headerCItitleD , info: [{link: 'Услуги', class: cl.headerCIItemD},{link: 'Кейсы', class: cl.headerCIItemB},{link: 'Тарифы', class: cl.headerCIItemB},{link: 'Цены', class: cl.headerCIItemB},{link: 'О компании', class: cl.headerCIItemB}, {link: 'Статьи', class: cl.headerCIItemB}, {link: 'Отзывы', class: cl.headerCIItemB}, {link: 'Контакты', class: cl.headerCIItemB}]}]
