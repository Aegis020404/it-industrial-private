...
const HeaderNav = ({active, headerNav, mainBlock, setHeaderNav, burgerA, setBurgerItem})=>{
    ...
    {title: 'Меню', titleClass: cl.headerCItitleD , info: [{link: 'Услуги', class: cl.headerCIItemD},{link: 'Кейсы', page:'/keys', class: cl.headerCIItemB},{link: 'Тарифы', page:'/tariffs', class: cl.headerCIItemB},{link: 'Отзывы',page:'/about', class: cl.headerCIItemB},{link: 'О компании', page: '/about', class: cl.headerCIItemB}, {link: 'Вакансии',page:'/vacancy', class: cl.headerCIItemB}, {link: 'Отзывы', page:'/reviews',class: cl.headerCIItemB}, {link: 'Контакты',page:'/contacts', class: cl.headerCIItemB}]}]
